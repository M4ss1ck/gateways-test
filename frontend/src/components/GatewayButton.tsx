    ...
    <>
      {!showDetails ? (
        ...
        Object.keys(details).length > 0 && (
          <>
            <li className="relative flex flex-col items-start p-2 m-2 border rounded-lg border-warning">
              <button
              ...
              {showRaw ? (
                <pre className="p-3 m-2 text-xs text-left text-light bg-opacity-30 bg-primary">
